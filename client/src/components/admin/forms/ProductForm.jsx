...
const ProductForm = ({ initialData = emptyProductData, onSubmit }) => {
  ...
  const submitHandler = (e) => {
    ...
    const offerPrice =
      formData.offerPrice === "" ? undefined : Number(formData.offerPrice);
  ...
  return (
    <form onSubmit={submitHandler} className="grid gap-5 md:grid-cols-2">
      <input
        ...
        className="rounded-2xl border border-orange-100 bg-orange-50/40 p-3 text-zinc-900 placeholder-zinc-400 transition focus:border-[#f97316] focus:outline-none focus:ring-2 focus:ring-orange-100"
        required
      />
      ...
      <select
        ...
        onChange={handleChange}
        className="rounded-2xl border border-orange-100 bg-orange-50/40 p-3 text-zinc-900 transition focus:border-[#f97316] focus:outline-none focus:ring-2 focus:ring-orange-100"
        required
      >
      ...
      <textarea
        ...
        onChange={handleChange}
        className="rounded-[1.25rem] border border-orange-100 bg-orange-50/40 p-3 text-zinc-900 placeholder-zinc-400 transition focus:border-[#f97316] focus:outline-none focus:ring-2 focus:ring-orange-100 md:col-span-2"
        required
      />
      ...
      <label className="flex items-center gap-2 text-sm font-semibold text-zinc-700 md:col-span-2">
        <input
          ...
          onChange={handleChange}
          className="h-4 w-4 rounded border-orange-200 text-[#f97316] focus:ring-[#f97316]"
        />
        Featured Product
      </label>
      ...
      <button
        type="submit"
        className="rounded-2xl bg-[#f97316] py-3 font-semibold text-white shadow-[0_10px_25px_rgba(249,115,22,0.16)] transition hover:bg-[#ea580c] md:col-span-2"
      >
        Save Product
      </button>
    </form>
